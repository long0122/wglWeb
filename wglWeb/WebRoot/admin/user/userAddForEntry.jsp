				...
				<td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td bgcolor="#F3FFEE">
								<!-- content  -->
								<form action="system/user!add" method="post" id="userForEntry">
														...
														<tbody>
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																...
																<td>
																	...
																	<input type="hidden" name="role" value="05">
															...
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																...
																<td>
																	&nbsp;&nbsp;
																	<s:select list="categorys" name="category" listKey="id" listValue="name" headerKey="%{admin.category.id}" headerValue="全部" />
