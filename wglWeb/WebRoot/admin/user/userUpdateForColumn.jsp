...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script src="admin/validate/user/userForColumn.js" type="text/javascript" charset="GBK"></script>
	</head>
				...
				<td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td bgcolor="#F3FFEE">
								<!-- content  -->
								<form action="system/user!update" method="post"  id="userForColumn">
													...
													<table border=0 cellspacing=1 cellpadding=0 width="100%">
														<tbody>
															...
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																...
																<td>
																	&nbsp;&nbsp;
																	<s:select list="categorys" name="category" listKey="id" listValue="name" value="staff.category.id" />
																	<font color="red">*</font>
																</td>
															</tr>
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
