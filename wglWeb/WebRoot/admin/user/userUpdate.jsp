													...
													<table border=0 cellspacing=1 cellpadding=0 width="100%">
														<tbody>
															...
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																...
																<td>
																	&nbsp;&nbsp;
																	<input type="password" name="password" value="${staff.password }">
																		<font color="red">*</font>
																</td>
															</tr>
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
															...
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																...
																<td>
																	...
																	<s:select list="roles" name="role" listKey="id"
																		listValue="name" headerKey="" headerValue="请选择" value="staff.role.id" />
																	<font color="red">*</font>
																</td>
															</tr>
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																...
																<td>
																	&nbsp;&nbsp;
																	<s:select list="provinces" name="province" listKey="provinceId" listValue="province" headerKey="" headerValue="请选择" value="staff.provinceId" onchange="selectCity(this.value)" />
																	<span id="city">
