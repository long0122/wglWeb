...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script src="admin/validate/user/userForEntry.js" type="text/javascript" charset="GBK"></script>
		<style type=text/css>
			.STYLE1 {
				FONT-FAMILY: "宋体";
				FONT-SIZE: 12px
				...
				<td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td bgcolor="#F3FFEE">
								<!-- content  -->
								<form action="system/user!update" method="post"  id="userForEntry">
														...
														<tbody>
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																...
																<td>
																    ...
																    <input type="hidden" name="city" value="${userAdmin.city.cityId }">
																	&nbsp;&nbsp;
															...
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																...
																<td>
																	&nbsp;&nbsp;
																	<s:select list="categorys" name="category" listKey="id" listValue="name" headerKey="%{admin.category.id}" headerValue="全部" value="%{staff.category.id}" />
