...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script src="admin/validate/user/userForCity.js" type="text/javascript" charset="GBK"></script>
		<style type=text/css>
			.STYLE1 {
				FONT-FAMILY: "宋体";
				FONT-SIZE: 12px
				...
				<td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td bgcolor="#F3FFEE">
								<!-- content  -->
								<form action="system/user!update" method="post"  id="userForCity">
													...
													<table border=0 cellspacing=1 cellpadding=0 width="100%">
														<tbody>
															...
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																...
																<td>
																	&nbsp;&nbsp;
																	<input type="text" name="nickname" value="${staff.nickname }">
																</td>
															</tr>
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																<td bgcolor=#EDFECF width="16%" align=right>
																...
																<td>
																	&nbsp;&nbsp;
																	<s:select list="provinces" name="province" listKey="provinceId" listValue="province" value="staff.provinceId" onchange="selectCity(this.value)" />
																	<span id="city">
																	<s:select list="citys" name="city" listKey="cityId" listValue="city" headerKey="" headerValue="请选择" value="staff.city.cityId" />
																	</span>
																	<font color="red">*</font>
																</td>
															</tr>
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																...
																<td>
																	&nbsp;&nbsp;
																	<s:select name="state" list="#{'1':'正常','0':'不可用'}" listKey="key" listValue="value" value="staff.state" />
																</td>
															</tr>
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																<td bgcolor=#EDFECF width="16%" align=right>
																...
																<td>
																	&nbsp;&nbsp;
																	<a href="system/user!toUpdatePwd?id=${staff.id}">更改密码</a>
