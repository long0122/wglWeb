		...
		<table width="100%" border="0" align="center" cellpadding="0"
							...
							<td bgcolor="#F3FFEE">
								<table width="99%" border="0" align="center" cellpadding="0"
										...
										<tr>
											...
											<td height="18" bgcolor="#FFFFFF">
												<div align="center">
													...
													<span class="STYLE1"> [<a
														href="system/user!toUpdate?userinfo.id=${u.id}">编辑</a>
													</span><span class="STYLE1">]&nbsp;&nbsp;&nbsp;&nbsp;<img
															src="admin/tab/images/010.gif" width="9" height="9" /><span
														class="STYLE1"> [</span><a
														href="system/user!delete?userinfo.id=${u.id}" onclick="return confirm('您确定删除吗?')">删除</a><span
									...
									<s:if test="users==null||users.size==0">
											<td height="18" bgcolor="#FFFFFF" class="STYLE2" colspan="6"><div align="center" class="STYLE2 STYLE1">暂无数据...</div></td>
									</s:if>
								</table>
							</td>
			...
			<tr>
				<td height="29">
					...
					<!-- 分页 -->
					<s:if test="users!=null&&users.size!=0">
					<form id="form3" name="form3" action="system/user!list" method="post">
