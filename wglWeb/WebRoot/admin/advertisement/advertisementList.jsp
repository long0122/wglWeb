		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td background="admin/tab/images/tab_05.gif">
								...
								<span class="STYLE4">广告列表</span>
							</td>
							<td align="right" background="admin/tab/images/tab_05.gif">
								<span class="STYLE4"><a href="system/ad!toAdd"><img
								...
								<table width="99%" border="0" align="center" cellpadding="0"
									...
									<c:forEach items="${adList}" var="ad">
										<tr>
											...
											<td height="18" bgcolor="#FFFFFF">
												<div align="center" class="STYLE2 STYLE1">
													${ad.city.province.province}&nbsp;${ad.city.city}
												</div>
											</td>
											<td height="18" bgcolor="#FFFFFF">
												<div align="center" class="STYLE2 STYLE1">
											...
											<td height="18" bgcolor="#FFFFFF">
												<div align="center">
														...
														<span class="STYLE1"> [<a
															href="system/ad!toUpdate?adInfo.id=${ad.id}">编辑</a>
														</span><span class="STYLE1">]&nbsp;&nbsp;&nbsp;&nbsp;<img
																src="admin/tab/images/010.gif" width="9" height="9" /><span
															class="STYLE1"> [</span><a
															href="system/ad!delete?adInfo.id=${ad.id}" onclick="return confirm('您确定删除吗?')">删除</a><span
															class="STYLE1">]</span> 
															&nbsp;&nbsp;&nbsp;&nbsp;
												
													<img src="admin/tab/images/011.gif" width="9" height="9" /><span
														class="STYLE1"> [</span><a
														href="system/ad!toSee?adInfo.id=${ad.id}">查看</a><span
			...
			<tr>
				<td height="29">
					...
					<!-- 分页 -->
					<s:if test="adList!=null&&adList.size!=0">
					<form id="form3" name="form3" action="ad" method="post">
