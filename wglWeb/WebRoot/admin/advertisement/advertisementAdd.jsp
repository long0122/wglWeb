				...
				<td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td bgcolor="#F3FFEE">
								<!-- content  -->
								<form id="adForm" action="system/ad!add" method="post"  enctype="multipart/form-data">
													...
													<table border=0 cellspacing=1 cellpadding=0 width="100%">
														<tbody>
															...
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																...
																<td>
																	&nbsp;&nbsp;
																	<s:select list="units" name="unit" listKey="id" listValue="name" headerKey="" headerValue="请选择" />
																		<font color="red">*</font>
																</td>
															</tr>
															<!-- 
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																...
																<td>
																	&nbsp;&nbsp;
																	<s:select name="commend" list="#{'0':'不推荐','1':'推荐'}" listKey="key" listValue="value" />
																		<font color="red">*</font>
																</td>
															</tr>
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																...
																<td>
																	&nbsp;&nbsp;
																	<s:select name="type" list="#{'1':'文字推荐','2':'图片推荐'}" listKey="key" listValue="value" />
																		<font color="red">*</font>
																</td>
															</tr>
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																...
																<td>
																	&nbsp;&nbsp;
																	<s:select name="commendTypeIndex" list="#{'':'请选择','1':'是','0':'否'}" listKey="key" listValue="value" onchange="selectCycle(this.value)" />
																</td>
															</tr>
															<tr class=STYLE1 height=30 bgcolor=#ffffff id="cycle" style="display: none;">
																...
																<td>
																	&nbsp;&nbsp;
																	<s:select name="commendCycle" list="#{'1':'8:00-10:30','2':'10:30-13:00','3':'13:00-17:00','4':'17:00-20:00','5':'20:00-8:30'}" listKey="key" listValue="value" />
																</td>
															</tr>
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																<td bgcolor=#EDFECF width="16%" align=right>
																...
																<td>
																	&nbsp;&nbsp;
																	<s:select name="commendTypeCategory" list="#{'':'请选择','1':'是','0':'否'}" listKey="key" listValue="value" />
																</td>
															</tr>
															 -->
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																...
																<td>
																	&nbsp;&nbsp;
																	<textarea name="contentShort" rows="" cols="" style="width: 400px; height: 100px;"></textarea>
																</td>
															</tr>
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																<td bgcolor=#EDFECF width="16%" align=right>
																...
																<td>
																	&nbsp;&nbsp;
																	<textarea id="kindeditor" name="content" cols="100" rows="8" style="width:700px;height:200px;visibility:hidden;"></textarea>
																</td>
															</tr>
															...
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																...
																<td>
																	&nbsp;&nbsp;
																	<s:select name="promotion" list="#{'0':'不促销','1':'促销'}" listKey="key" listValue="value" onchange="selectPro(this.value)" />
																</td>
															</tr>
															<tr class=STYLE1 height=30 bgcolor=#ffffff id="pro" style="display: none;">
																<td bgcolor=#EDFECF width="16%" align=right>
																	促销价格：&nbsp;&nbsp;
																</td>
																<td>
															...
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																...
																<td>
													                ...
													                <span class="STYLE6">提示：为了前台页面显示效果,请上传宽和高比例为1:1(正方形)的图片</span>
																</td>
															</tr>
															<!-- 
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																...
																<td>
																	&nbsp;&nbsp;
																	<input type="text" name="orderIndex">
																</td>
															</tr>
