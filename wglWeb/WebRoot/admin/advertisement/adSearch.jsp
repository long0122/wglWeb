				...
				<td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td bgcolor="#F3FFEE">
								<!-- content  -->
								<form id="adForm" action="system/ad!search" method="post" >
													...
													<table border=0 cellspacing=1 cellpadding=0 width="100%">
														<tbody>
															...
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																...
																<td>
																	&nbsp;&nbsp;
																	<s:select name="commend" list="#{'':'请选择','0':'不推荐','1':'推荐'}" listKey="key" listValue="value" />
																</td>
															</tr>
															<!-- 
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
															...
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																...
																<td>
																	&nbsp;&nbsp;
																	<s:select name="promotion" list="#{'':'请选择','0':'不促销','1':'促销'}" listKey="key" listValue="value"/> <!-- onchange="selectPro(this.value)" /> -->
																</td>
															</tr>
															<!-- 
