									...
									<c:forEach items="${adList}" var="ad">
										<tr>
											...
											<td height="18" bgcolor="#FFFFFF">
												...
												<td height="18" bgcolor="#FFFFFF">
												<div align="center" class="STYLE2 STYLE1">
												<c:set value="${session_ad_commend_cycle}" var="commend_cycle"></c:set>
													<c:if test="${fn:contains(ad.commendCycle,commend_cycle)}">
											...
											<td height="18" bgcolor="#FFFFFF">
												<div align="center">
												<c:choose> 
													<c:when test="${fn:contains(ad.commendCycle,commend_cycle)}">
