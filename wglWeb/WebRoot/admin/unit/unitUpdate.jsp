				...
				<td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td bgcolor="#F3FFEE">
								<!-- content  -->
								<form id="unitAddForm" action="system/unit!update" method="post"  enctype="multipart/form-data">
													...
													<table border=0 cellspacing=1 cellpadding=0 width="100%">
														<tbody>
															...
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																...
																<td>
																	&nbsp;&nbsp;
																	<s:select list="categorys" name="category" listKey="id" listValue="name" headerKey="" headerValue="请选择" value="unit.category.id"/>
																		<font color="red">*</font>
																</td>
															</tr>
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																...
																<td>
																	&nbsp;&nbsp;
																	<input type="text" name="address" value="${unit.address }">
															...
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																...
																<td>
																	&nbsp;&nbsp;
																	<input type="text" name="phone" value="${unit.phone }">
																</td>
															</tr>
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
																<td bgcolor=#EDFECF width="16%" align=right>
																...
																<td>
																	&nbsp;&nbsp;
																	<textarea id="kindeditor" name="contact" cols="100" rows="8" style="width:700px;height:200px;visibility:hidden;">${unit.contact }</textarea>
																	<font color="red">*</font>
																</td>
															</tr>
															<tr class=STYLE1 height=30 bgcolor=#ffffff>
