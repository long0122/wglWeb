		...
		<table width="100%" border="0" align="center" cellpadding="0"
							...
							<td bgcolor="#F3FFEE">
								<table width="99%" border="0" align="center" cellpadding="0"
										...
										<tr>
											...
											<td height="18" bgcolor="#FFFFFF">
												...
												<c:choose>
													...
													<span class="STYLE1 grey"> [审核<span
														class="STYLE1">]&nbsp;&nbsp;&nbsp;&nbsp;</span></span>
													</c:when>
													<c:otherwise>	
														<img src="admin/tab/images/037.gif" width="9" height="9" />
													<span class="STYLE1"> [<a
														href="system/unit!toAudit?unitInfo.id=${u.id}">审核</a></span><span
														class="STYLE1">]&nbsp;&nbsp;&nbsp;&nbsp;
													</c:otherwise>
												</c:choose>
														<!-- 	<img
														...
														class="STYLE1"> [</span><a
														href="system/unit!delete?unitInfo.id=${u.id}" onclick="return confirm('您确定删除吗?')">删除</a><span
									...
									<s:if test="units==null||units.size==0">
										<td height="18" bgcolor="#FFFFFF" class="STYLE2" colspan="6">
											<div align="center" class="STYLE2 STYLE1">
												暂无数据...
											</div>
										</td>
			...
			<tr>
				<td height="29">
					...
					<!-- 分页 -->
					<s:if test="units!=null&&units.size!=0">
						<form id="form3" name="form3" action="system/unit!showAuditUnitList" method="post">
